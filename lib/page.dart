...
class PaperFormat {
  static const letter = PaperFormat.inches(name: "letter", width: 8.5, height: 11);
  static const legal = PaperFormat.inches(name: "legal", width: 8.5, height: 14);
  static const tabloid = PaperFormat.inches(name: "tabloid", width: 11, height: 17);
  static const ledger = PaperFormat.inches(name: "ledger", width: 17, height: 11);
  static const a0 = PaperFormat.inches(name: "a0", width: 33.1, height: 46.8);
  static const a1 = PaperFormat.inches(name: "a1", width: 23.4, height: 33.1);
  static const a2 = PaperFormat.inches(name: "a2", width: 16.54, height: 23.4);
  static const a3 = PaperFormat.inches(name: "a3", width: 11.7, height: 16.54);
  static const a4 = PaperFormat.inches(name: "a4", width: 8.27, height: 11.7);
  static const a5 = PaperFormat.inches(name: "a5", width: 5.83, height: 8.27);
  static const a6 = PaperFormat.inches(name: "a6", width: 4.13, height: 5.83);
  ...
  const PaperFormat.inches({this.name = "", required this.width, required this.height});

  PaperFormat.px({this.name = "", required int width, required int height})
      : width = _pxToInches(width),
        height = _pxToInches(height);

  PaperFormat.cm({this.name = "", required num width, required num height})
